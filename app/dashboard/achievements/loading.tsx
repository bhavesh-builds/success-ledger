  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-50 dark:from-zinc-950 dark:via-black dark:to-zinc-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="h-8 w-20 bg-zinc-200 dark:bg-zinc-700 rounded animate-pulse"></div>
            </div>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <div className="h-10 w-64 bg-zinc-200 dark:bg-zinc-700 rounded mb-2 animate-pulse"></div>
          <div className="h-6 w-48 bg-zinc-200 dark:bg-zinc-700 rounded animate-pulse"></div>
        </div>

        <SearchSkeleton />
        <AchievementListSkeleton count={6} />
      </main>
    </div>
  )
}
